...
const About = () => {
  ...
  return (
    <>
      <h1 className="flex justify-center text-5xl py-20 bg-[#D9D9D97A]"> About Us</h1>
      <img src="images/phone-book 1.png" alt="phonebook" 
      className="absolute w-[80px] h-[80px] left-[725px] top-[272px]"/>
